...
import { ChevronLeft, Save, XCircle, FileText, Calendar, User, DollarSign, ClipboardList } from "lucide-react";
    ...
    <div className="p-4 md:p-6 w-full mx-auto">
      ...
      <nav className="mb-4 text-gray-600 hidden md:block">
        <ol className="flex space-x-2 text-sm">
          ...
          <li>/</li>
          <li className="font-semibold flex items-center">Edit Invoice</li>
        </ol>
      </nav>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 border-b">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Update the billing information and transaction details
          </p>
        </div>
