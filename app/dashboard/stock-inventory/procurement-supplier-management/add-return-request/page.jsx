    ...
    try {
      ...
      const res = await fetch("/api/purchase-request-order", {
        ...
        body: JSON.stringify({
          ...
          type: "returnHandlingDefectiveMaterial", // Specify type for return request
        }),
      });
    ...
    <div className="p-6 w-full">
      ...
      <nav className="mb-4 text-gray-600">
        <ol className="flex space-x-2 text-sm">
          ...
          <li>/</li>
          <li className="font-semibold flex items-center">Add Return Request</li>
        </ol>
      </nav>

      {/* Page Header */}
      <div className="flex justify-between items-center mb-6 border-b pb-4">
        <h1 className="text-4xl font-bold text-gray-800">Add Return Request</h1>
      </div>
