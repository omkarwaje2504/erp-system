...
import { ChevronLeft, Save, XCircle, Calendar, Truck, Package, AlertTriangle, RotateCcw } from "lucide-react";

export default function AddReturnRequest() {
  ...
  useEffect(() => {
    const storedData = localStorage.getItem("returnRequest");
    if (storedData) {
      ...
      setIsEdit(true);
      localStorage.removeItem("returnRequest");
    }
  }, []);
    ...
    try {
      ...
      const res = await fetch("/api/purchase-request-order", {
        ...
        body: JSON.stringify({
          ...formData,
          date: formattedDate,
          type: "returnHandlingDefectiveMaterial",
        }),
      });
      ...
      <nav className="mb-4 text-gray-600 hidden md:block">
        <ol className="flex space-x-2 text-sm">
          ...
          <li className="font-semibold flex items-center">
            {isEdit ? "Edit" : "Add"} Return Request
          </li>
        </ol>
      </nav>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 border-b">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Enter the details for your material return request
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Issue/Reason for Return <span className="text-red-500">*</span>
              </label>
              <div className="relative">
                <textarea
                  name="issue"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                placeholder="Enter any additional details about this return request"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
